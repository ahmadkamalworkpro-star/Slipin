              ...
              <>
                ...
                <View style={styles.previewTags}>
                  {selectedUser.tags.map((tag) => (
                    <TagBadge key={tag} label={tag} selected />
                  ))}
                </View>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    navigation.navigate("Chat", { userId: selectedUser.id, userName: selectedUser.name });
                  }}
                >
          ...
          <View style={styles.radiusCard}>
            ...
            {RADIUS_OPTIONS.map((opt) => (
              <TouchableOpacity
                ...
                style={[
                  styles.radiusOption,
                  radius === opt.label && styles.radiusOptionSelected,
                ]}
                onPress={() => {
                  setRadius(opt.label);
              ...
              >
                ...
                <View style={styles.radiusTextWrap}>
                  <Text style={[styles.radiusLabel, radius === opt.label && { color: COLORS.neon }]}>
                    {opt.label}
                  </Text>
                  <Text style={styles.radiusSublabel}>{opt.sublabel}</Text>
                </View>
                {radius === opt.label && (
                  <View style={styles.radiusCheck} />
                )}
              </TouchableOpacity>
            ))}
          </View>
